...
class BaliseTelegramGeneratorTest {
	...
	void receivePosition() throws InterruptedException {
		...
		lob.addBaliseGroup(new BaliseGroup(M_VERSION_2_0, 0, 0, 0, 0, 0, false, null));
		lob.addBaliseGroup(new BaliseGroup(M_VERSION_2_0, 0, 1, 0, 0,500, false, null));
		lob.addBaliseGroup(new BaliseGroup(M_VERSION_2_0, 0, 2, 1, 0,500, false, null));
		...
		// TODO trainID
		EventBus.getDefault().post(new PositionEvent("mr;T=test", "btg", new Position(500d, true, new Location(1, 0, 0,10d))));
