...
public class GradientProfileConverter {
	...
	/**
	 * This method converts a {@link Packet_21} and returns a profile that contains distances in [m] and acceleration in [m/s�].
	 ...
	 * 		{@link BreakingCurveRequestEvent#currentGradient}
	 * @return
	...
	public static ForwardSpline package21ToGP(Packet_21 p21, double currentGradient) {
		 ...
		 */
		List<Packet_21_Gradient> gradients = p21.gradients;
		 ...
		 */
		for (Packet_21_Gradient gradient : gradients) {
