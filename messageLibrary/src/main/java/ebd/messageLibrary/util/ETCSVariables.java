...
/**
 * Collection Of Constants Used In ETCS Variables
 *
 * @version 2.0
...
public class ETCSVariables {
    ...
    public static final int     INTEGER_NOVALUE  = 0;
    public static final long    LONG_NOVALUE    = 0;
     ...
     * Resolution: 1 m
     */
    public static final int L_TRAININT = INTEGER_NOVALUE;
     ...
     * FFFF FFFF: Spare
     */
    public static final BinaryCodedDecimal NID_OPERATIONAL = new BinaryCodedDecimal(LONG_NOVALUE, 8);
     ...
     */
    public static final BinaryCodedDecimal NID_RADIO              = new BinaryCodedDecimal(LONG_NOVALUE, 16);
    public static final BinaryCodedDecimal NID_RADIO_SHORT_NUMBER = new BinaryCodedDecimal(-1L, 16);
     ...
     * Resolution: 10 ms
     */
    public static final long T_TRAIN         = LONG_NOVALUE;
