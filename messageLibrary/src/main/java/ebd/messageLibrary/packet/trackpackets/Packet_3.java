...
public class Packet_3 extends TrackPacketSCALE {
	...
	public static class Packet_3_Area {
		 ...
		 * @author Christopher Bernjus
		 */
		public Packet_3_Area(int NID_C) {
			this.NID_C = NID_C;
		}
		...
		public boolean equals(Object object) {
			...
			Packet_3_Area that = (Packet_3_Area) object;
			return NID_C == that.NID_C;
		}

		@Override
		public String toString() {
			return "Packet_3_Area{"
				   + "NID_C=" + NID_C
				   + '}';
		}
	...
	public static class Packet_3_KV_Speed_Step {
		...
		public boolean equals(Object object) {
			if(this == object) return true;
			if(object == null || getClass() != object.getClass()) return false;
			Packet_3_KV_Speed_Step that = (Packet_3_KV_Speed_Step) object;
			return V_NVKVINT == that.V_NVKVINT && M_NVKVINT12 == that.M_NVKVINT12 && M_NVKVINT23 == that.M_NVKVINT23;
		}

		@Override
		public String toString() {
			return "Packet_3_KV_Speed_Step{"
				   + "V_NVKVINT=" + V_NVKVINT + ", M_NVKVINT12=" + M_NVKVINT12 + ", M_NVKVINT23=" + M_NVKVINT23
				   + '}';
		}
	...
	public static class Packet_3_Integrated_Correction_Factor {
		...
		public boolean equals(Object object) {
			if(this == object) return true;
			if(object == null || getClass() != object.getClass()) return false;
			Packet_3_Integrated_Correction_Factor that = (Packet_3_Integrated_Correction_Factor) object;
			return Q_NVKVINTSET == that.Q_NVKVINTSET && A_NVP12 == that.A_NVP12 && A_NVP23 == that.A_NVP23 &&
				   Objects.equals(speed_step, that.speed_step) && Objects.equals(speed_steps, that.speed_steps);
		}

		@Override
		public String toString() {
			return "Packet_3_Integrated_Correction_Factor{"
				   + "Q_NVKVINTSET=" + Q_NVKVINTSET + ", A_NVP12=" + A_NVP12 + ", A_NVP23=" + A_NVP23
				   + ", speed_step=" + speed_step.toString()
				   + ", speed_steps=" + speed_steps.toString()
				   + '}';
		}
	...
	public static class Packet_3_KR_Length_Step {
		...
		public boolean equals(Object object) {
			if(this == object) return true;
			if(object == null || getClass() != object.getClass()) return false;
			Packet_3_KR_Length_Step that = (Packet_3_KR_Length_Step) object;
			return L_NVKRINT == that.L_NVKRINT && M_NVKRINT == that.M_NVKRINT;
		}

		@Override
		public String toString() {
			return "Packet_3_KR_Length_Step{"
				   + "L_NVKRINT=" + L_NVKRINT + ", M_NVKRINT=" + M_NVKRINT
				   + '}';
		}
	...
	public boolean equals(Object object) {
		...
		return D_VALIDNV == packet_3.D_VALIDNV && V_NVSHUNT == packet_3.V_NVSHUNT && V_NVSTFF == packet_3.V_NVSTFF &&
			   V_NVONSIGHT == packet_3.V_NVONSIGHT && V_NVLIMSUPERV == packet_3.V_NVLIMSUPERV && V_NVUNFIT == packet_3.V_NVUNFIT &&
			   V_NVREL == packet_3.V_NVREL && D_NVROLL == packet_3.D_NVROLL && Q_NVSBTSMPERM == packet_3.Q_NVSBTSMPERM &&
			   Q_NVEMRRLS == packet_3.Q_NVEMRRLS && Q_NVGUIPERM == packet_3.Q_NVGUIPERM && Q_NVSBFBPERM == packet_3.Q_NVSBFBPERM &&
			   Q_NVINHSMICPERM == packet_3.Q_NVINHSMICPERM && V_NVALLOWOVTRP == packet_3.V_NVALLOWOVTRP && V_NVSUPOVTRP == packet_3.V_NVSUPOVTRP &&
			   D_NVOVTRP == packet_3.D_NVOVTRP && T_NVOVTRP == packet_3.T_NVOVTRP && D_NVPOTRP == packet_3.D_NVPOTRP &&
			   M_NVCONTACT == packet_3.M_NVCONTACT && T_NVCONTACT == packet_3.T_NVCONTACT && M_NVDERUN == packet_3.M_NVDERUN &&
			   D_NVSTFF == packet_3.D_NVSTFF && Q_NVDRIVER_ADHES == packet_3.Q_NVDRIVER_ADHES && A_NVMAXREDADH1 == packet_3.A_NVMAXREDADH1 &&
			   A_NVMAXREDADH2 == packet_3.A_NVMAXREDADH2 && A_NVMAXREDADH3 == packet_3.A_NVMAXREDADH3 && Q_NVLOCACC == packet_3.Q_NVLOCACC &&
			   M_NVAVADH == packet_3.M_NVAVADH && M_NVEBCL == packet_3.M_NVEBCL && Q_NVKINT == packet_3.Q_NVKINT && M_NVKTINT == packet_3.M_NVKTINT &&
			   Objects.equals(area, packet_3.area) && areas.equals(packet_3.areas) &&
			   Objects.equals(integrated_correction_factor, packet_3.integrated_correction_factor) &&
			   integrated_correction_factors.equals(packet_3.integrated_correction_factors) &&
			   Objects.equals(length_step, packet_3.length_step) && length_steps.equals(packet_3.length_steps);
	}
	...
	public String toString() {
		return "Packet_3{"
			   ...
			   + ", V_NVSHUNT=" + V_NVSHUNT  + ", V_NVSTFF=" + V_NVSTFF + ", V_NVONSIGHT=" + V_NVONSIGHT + ", V_NVLIMSUPERV=" + V_NVLIMSUPERV
			   + ", V_NVUNFIT=" + V_NVUNFIT + ", V_NVREL=" + V_NVREL + ", D_NVROLL=" + D_NVROLL
			   + ", Q_NVSBTSMPERM=" + Q_NVSBTSMPERM + ", Q_NVEMRRLS=" + Q_NVEMRRLS + ", Q_NVGUIPERM=" + Q_NVGUIPERM
			   + ", Q_NVSBFBPERM=" + Q_NVSBFBPERM + ", Q_NVINHSMICPERM=" + Q_NVINHSMICPERM + ", V_NVALLOWOVTRP=" + V_NVALLOWOVTRP
			   + ", V_NVSUPOVTRP=" + V_NVSUPOVTRP + ", D_NVOVTRP=" + D_NVOVTRP + ", T_NVOVTRP=" + T_NVOVTRP
			   + ", D_NVPOTRP=" + D_NVPOTRP + ", M_NVCONTACT=" + M_NVCONTACT + ", T_NVCONTACT=" + T_NVCONTACT
			   + ", M_NVDERUN=" + M_NVDERUN + ", D_NVSTFF=" + D_NVSTFF + ", Q_NVDRIVER_ADHES=" + Q_NVDRIVER_ADHES
			   + ", A_NVMAXREDADH1=" + A_NVMAXREDADH1 + ", A_NVMAXREDADH2=" + A_NVMAXREDADH2 + ", A_NVMAXREDADH3=" + A_NVMAXREDADH3
			   + ", Q_NVLOCACC=" + Q_NVLOCACC + ", M_NVAVADH=" + M_NVAVADH + ", M_NVEBCL=" + M_NVEBCL + ", Q_NVKINT=" + Q_NVKINT
			   + ", integrated_correction_factor=" + integrated_correction_factor.toString()
			   + ", integrated_correction_factors=" + integrated_correction_factors.toString()
			   + ", length_step=" + length_step.toString()
			   + ", length_steps=" + length_steps.toString()
			   + ", M_NVKTINT=" + M_NVKTINT
			   + '}';
	}
