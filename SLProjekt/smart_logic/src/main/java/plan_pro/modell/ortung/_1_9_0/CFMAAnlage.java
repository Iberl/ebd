 ...
 *       &lt;sequence>
 *         &lt;element name="Bezeichnung" type="{http://www.plan-pro.org/modell/Ortung/1.9.0.2}CFMA_Anlage_Bezeichnung"/>
 *         &lt;element name="FMA_Anlage_Allg" type="{http://www.plan-pro.org/modell/Ortung/1.9.0.2}CFMA_Anlage_Allg"/>
 *         &lt;element name="FMA_Anlage_Elektr_Merkmale" type="{http://www.plan-pro.org/modell/Ortung/1.9.0.2}CFMA_Anlage_Elektr_Merkmale" minOccurs="0"/>
 *         &lt;element name="FMA_Anlage_Kaskade" type="{http://www.plan-pro.org/modell/Ortung/1.9.0.2}CFMA_Anlage_Kaskade" minOccurs="0"/>
 *         &lt;element name="FMA_Anlage_Uebertragung_FMinfo" type="{http://www.plan-pro.org/modell/Ortung/1.9.0.2}CFMA_Anlage_Uebertragung_FMinfo" minOccurs="0"/>
 *         &lt;element name="ID_Gleis_Abschnitt" type="{http://www.plan-pro.org/modell/Verweise/1.9.0.2}TCID_Gleis_Abschnitt"/>
 *         &lt;element name="ID_Gleisfreimelde_Innenanlage" type="{http://www.plan-pro.org/modell/Verweise/1.9.0.2}TCID_Aussenelementansteuerung"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
