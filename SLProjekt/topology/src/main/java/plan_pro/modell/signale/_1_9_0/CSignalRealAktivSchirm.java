 ...
 *       &lt;sequence>
 *         &lt;element name="Dunkelschaltung" type="{http://www.plan-pro.org/modell/Signale/1.9.0.2}TCDunkelschaltung" minOccurs="0"/>
 *         &lt;element name="Richtpunkt" type="{http://www.plan-pro.org/modell/Signale/1.9.0.2}TCRichtpunkt" minOccurs="0"/>
 *         &lt;element name="Richtpunktentfernung" type="{http://www.plan-pro.org/modell/Signale/1.9.0.2}TCRichtpunktentfernung"/>
 *         &lt;element name="Signal_Art" type="{http://www.plan-pro.org/modell/Signale/1.9.0.2}TCSignal_Art"/>
 *         &lt;element name="Signalsystem" type="{http://www.plan-pro.org/modell/Signale/1.9.0.2}TCSignalsystem"/>
 *         &lt;element name="Streuscheibe_Art" type="{http://www.plan-pro.org/modell/Signale/1.9.0.2}TCStreuscheibe_Art" minOccurs="0"/>
 *         &lt;element name="Streuscheibe_Betriebsstellung" type="{http://www.plan-pro.org/modell/Signale/1.9.0.2}TCStreuscheibe_Betriebsstellung" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class CSignalRealAktivSchirm {
    ...
    @XmlElement(name = "Dunkelschaltung")
