 ...
 *       &lt;sequence>
 *         &lt;element name="ID_Gleis_Abschnitt" type="{http://www.plan-pro.org/modell/Verweise/1.9.0.2}TCID_Gleis_Abschnitt" minOccurs="0"/>
 *         &lt;element name="ID_ZLV_Bus" type="{http://www.plan-pro.org/modell/Verweise/1.9.0.2}TCID_ZLV_Bus" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="ID_ZN" type="{http://www.plan-pro.org/modell/Verweise/1.9.0.2}TCID_ZN"/>
 *         &lt;element name="ID_ZN_Anzeigefeld" type="{http://www.plan-pro.org/modell/Verweise/1.9.0.2}TCID_ZN_Anzeigefeld" minOccurs="0"/>
 *         &lt;element name="ZN_Anzeigefeld_Allg" type="{http://www.plan-pro.org/modell/Zugnummernmeldeanlage/1.9.0.2}CZN_Anzeigefeld_Allg" minOccurs="0"/>
 *         &lt;element name="ZN_Anzeigefeld_Bezeichnung" type="{http://www.plan-pro.org/modell/Zugnummernmeldeanlage/1.9.0.2}CZN_Anzeigefeld_Bezeichnung"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
