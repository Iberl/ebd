...
public class DMISpeedUpdateEvent extends NormalEvent {
...
>>>>>>> dev_trainSide
     ...
     */
    public DMISpeedUpdateEvent(String source, String target, double currentSpeed, double targetSpeed, int targetDistance, double releaseSpeed,
