...
public class DrivingDynamics {
    ...
    public void clockTick(ClockTickEvent cte){
        ...
        if(this.locked || this.tripProfile == null){
            ...
            String target = "dmi";
            EventBus.getDefault().post(new DMIUpdateEvent(source, target, 0, 0, (int)0,
    ...
    private void updateDMI(){
        ...
        EventBus.getDefault().post(new DMIUpdateEvent(source, target, speed, targetSpeed, (int)distanceToDrive,
