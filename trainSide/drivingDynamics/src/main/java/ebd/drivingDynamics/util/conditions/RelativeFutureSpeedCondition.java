 ...
 *           {"type" : "v_trel", "condition" : {"op" : "<", "value" : 50, "value_t" = 120 }}<br>
...
public class RelativeFutureSpeedCondition extends Condition{
     ...
     */
    public RelativeFutureSpeedCondition(EventBus localEventBus, JSONObject jsonObject) throws DDBadDataException {
        super(localEventBus);
    ...
    public boolean eval() {
        ...
        maxSpeed = maxSpeed * this.speedPercentage;
