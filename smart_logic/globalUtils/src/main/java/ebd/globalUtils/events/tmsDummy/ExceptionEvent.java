...
public class ExceptionEvent extends Event {
     ...
     */
    @NotNull
    public ebd.globalUtils.events.tmsDummy.ExceptionEventTyp exceptionEventTyp = ebd.globalUtils.events.tmsDummy.ExceptionEventTyp.CRITICAL;

	/**
	 * The Event causing an Exception. If there is not a Event causing the exception,
	 * use a {@link ebd.globalUtils.events.tmsDummy.NotCausedByAEvent}
	 */
	@NotNull
	public Event cause;
	...
	public ExceptionEvent(String source, String target, @NotNull Exception exception){
		...
		this.cause = new ebd.globalUtils.events.tmsDummy.NotCausedByAEvent();
		this.exceptionEventTyp = ebd.globalUtils.events.tmsDummy.ExceptionEventTyp.CRITICAL;
	}
	 ...
	 */
	public ExceptionEvent(String source, String target, @NotNull Exception exception, @NotNull ebd.globalUtils.events.tmsDummy.ExceptionEventTyp exceptionEventTyp){
		super(source,target);
		this.exception = exception;
		this.cause = new ebd.globalUtils.events.tmsDummy.NotCausedByAEvent();
	 ...
	 */
	public ExceptionEvent(String source, String target, @NotNull Event cause, @NotNull Exception exception, @NotNull ebd.globalUtils.events.tmsDummy.ExceptionEventTyp exceptionEventTyp) {
		super(source, target);
		this.cause = cause;
		this.exception = exception;
		this.exceptionEventTyp = exceptionEventTyp;
