 ...
 * 
 * F�r jeden Signalbegriff wird eine eigene Instanz des Objektes angelegt. Die Attribute \"Kurzbezeichnung_DS\", \"Kurzbezeichnung_DV\", \"Langbezeichnung\", \"Beschreibung\", \"Geltungsbereich_DS\", \"Geltungsbereich_DV\",\"Geltungsbereich_SBahn_Berlin\", \"Geltungsbereich_SBahn_Hamburg\" sowie \"Gueltig_Ab\", \"Gueltig_Bis\", \"Beleuchtbar\", \"Schaltbar\", \"Zusatz_Moeglich\" und \"Anmerkungen\" sind dabei modellseitig fixierte Eigenschaften. Mittels des Attributs \"Symbol\" k�nnen planungsseitig in einigen F�llen Wertangaben erfolgen.
 * 
 * Sonstige w�hlbare Eigenschaften des Signals sind im Objekt Signal Signalbegriff enthalten.
 * 
 * Die Struktur der Signalbegriffsmodellierung (Anzahl und Auspr�gung der Attribute) und die Inhalte (konkrete Signalbegriffe) sind in zwei getrennten XSD-Dateien enthalten, um sp�ter eine separate Bearbeitung zu erm�glichen: 
 * � Signalbegriffe_Struktur.xsd, 
 * � Signalbegriffe_Ril_301.xsd. 
 * 
 * Weitere Erl�uterungen hierzu siehe Media:2013-10-08 Einfuehrung Komponenten XSD.pdf.
 * 
 ...
 * </Signal_Signalbegriff>
 * 
 * Ein vollst�ndige XML-Datei mit drei verschiedenen Signalbegriffen finden Sie hier: Media:adorf.xml.
 * 
...
public class TCSignalbegriffID {
