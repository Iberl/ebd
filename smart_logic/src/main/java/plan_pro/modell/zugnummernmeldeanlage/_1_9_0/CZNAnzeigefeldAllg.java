 ...
 *       &lt;sequence>
 *         &lt;element name="Bedienbarkeit_Anzeigefeld" type="{http://www.plan-pro.org/modell/Zugnummernmeldeanlage/1.9.0.2}TCBedienbarkeit_Anzeigefeld"/>
 *         &lt;element name="Bf_Nr_ANB" type="{http://www.plan-pro.org/modell/Zugnummernmeldeanlage/1.9.0.2}TCBf_Nr_ANB" minOccurs="0"/>
 *         &lt;element name="Bf_Nr_ZN_A" type="{http://www.plan-pro.org/modell/Zugnummernmeldeanlage/1.9.0.2}TCBf_Nr_ZN_A"/>
 *         &lt;element name="Funktionalitaet_Anzeigefeld" type="{http://www.plan-pro.org/modell/Zugnummernmeldeanlage/1.9.0.2}TCFunktionalitaet_Anzeigefeld"/>
 *         &lt;element name="HOA" type="{http://www.plan-pro.org/modell/Zugnummernmeldeanlage/1.9.0.2}TCHOA" minOccurs="0"/>
 *         &lt;element name="Sichtbarkeit_Anzeigefeld" type="{http://www.plan-pro.org/modell/Zugnummernmeldeanlage/1.9.0.2}TCSichtbarkeit_Anzeigefeld"/>
 *         &lt;element name="Verzoegerung_Manuell_Loeschung" type="{http://www.plan-pro.org/modell/Zugnummernmeldeanlage/1.9.0.2}TCVerzoegerung_Manuell_Loeschung" minOccurs="0"/>
 *         &lt;element name="Vormeldestart" type="{http://www.plan-pro.org/modell/Zugnummernmeldeanlage/1.9.0.2}TCVormeldestart" minOccurs="0"/>
 *         &lt;element name="ZN_Anzeigefeld_Loeschkriterium" type="{http://www.plan-pro.org/modell/Zugnummernmeldeanlage/1.9.0.2}TCZN_Anzeigefeld_Loeschkriterium" minOccurs="0"/>
 *         &lt;element name="ZN_Feld_Ohne_Anzeige" type="{http://www.plan-pro.org/modell/Zugnummernmeldeanlage/1.9.0.2}TCZN_Feld_Ohne_Anzeige" minOccurs="0"/>
 *         &lt;element name="Zugvorbereitungsmeldung" type="{http://www.plan-pro.org/modell/Zugnummernmeldeanlage/1.9.0.2}TCZugvorbereitungsmeldung" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
