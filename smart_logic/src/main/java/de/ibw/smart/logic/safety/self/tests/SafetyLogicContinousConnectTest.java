...
public class SafetyLogicContinousConnectTest {
    ...
    private TrackElement handleBeginOnBalise(ArrayList<Pair<Route.TrackElementType, ITrackElement>> routeResult, ArrayList<TrackElement> visitedElements, TestUtil.RouteConfig TestConfig) {
        I_CURRENT_TRYS = 0;
    ...
    private TrackElement handleBeginOnEdge(ArrayList<Pair<Route.TrackElementType, ITrackElement>> routeResult, ArrayList<TrackElement> visitedElements) {
        boolean bDirectionNodeA = new Random().nextBoolean();
    ...
    private TrackElement provideTrackElement4Edge(ArrayList<Pair<Route.TrackElementType, ITrackElement>> routeResult, ArrayList<TrackElement> visitedElements, boolean bDirectionNodeA, TopologyGraph.Edge oldEdge) {
    ...
    private TrackElement handleBeginOnNode(ArrayList<Pair<Route.TrackElementType, ITrackElement>> routeResult, ArrayList<TrackElement> visitedElements) {
        TrackElement CurrentElement;
    ...
    private ArrayList<Pair<Route.TrackElementType, ITrackElement>> returnFinishedRoute(ArrayList<Pair<Route.TrackElementType, ITrackElement>> routeResult, ArrayList<TrackElement> visitedElements, TopologyGraph.Edge newWay) {
    ...
    private TrackElement prepareNewIteration(ArrayList<Pair<Route.TrackElementType, ITrackElement>> routeResult, ArrayList<TrackElement> visitedElements, TopologyGraph.Edge newWay) {
        TrackElement CurrentElement;
    ...
    private TopologyGraph.Node pickRandomNode(Pair<Route.TrackElementType, ITrackElement> notConnectedWith) {
        TrackElement ElementNotConnectedWith = (TrackElement) notConnectedWith.getRight();
