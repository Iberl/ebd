...
public class RouteDataSL extends ArrayList<Pair<de.ibw.tms.ma.Route.TrackElementType, NetworkResource>> {

    public BigDecimal getRouteLength() {
        BigDecimal result = new BigDecimal("0");
        Iterator<Pair<de.ibw.tms.ma.Route.TrackElementType, NetworkResource>> it = this.iterator();
        while(it.hasNext()) {
            Pair<de.ibw.tms.ma.Route.TrackElementType, NetworkResource> element = it.next();
