 ...
 *       &lt;sequence>
 *         &lt;element name="Planung_E_Abnahme" type="{http://www.plan-pro.org/modell/PlanPro/1.9.0.2}CAkteur_Zuordnung" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="Planung_E_Erstellung" type="{http://www.plan-pro.org/modell/PlanPro/1.9.0.2}CAkteur_Zuordnung" maxOccurs="unbounded"/>
 *         &lt;element name="Planung_E_Freigabe" type="{http://www.plan-pro.org/modell/PlanPro/1.9.0.2}CAkteur_Zuordnung" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="Planung_E_Genehmigung" type="{http://www.plan-pro.org/modell/PlanPro/1.9.0.2}CAkteur_Zuordnung" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="Planung_E_Gleichstellung" type="{http://www.plan-pro.org/modell/PlanPro/1.9.0.2}CAkteur_Zuordnung" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="Planung_E_Pruefung" type="{http://www.plan-pro.org/modell/PlanPro/1.9.0.2}CAkteur_Zuordnung" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="Planung_E_Qualitaetspruefung" type="{http://www.plan-pro.org/modell/PlanPro/1.9.0.2}CAkteur_Zuordnung" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="Planung_E_Sonstige" type="{http://www.plan-pro.org/modell/PlanPro/1.9.0.2}CAkteur_Zuordnung" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="Planung_E_Uebernahme" type="{http://www.plan-pro.org/modell/PlanPro/1.9.0.2}CAkteur_Zuordnung" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
