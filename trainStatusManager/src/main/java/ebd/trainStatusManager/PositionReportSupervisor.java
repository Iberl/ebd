...
public class PositionReportSupervisor {
    ...
    public PositionReportSupervisor(EventBus localBus, String etcsTrainID, String rbcID){
        ...
        this.messageDestination = Arrays.asList("mr;R=" + rbcID);
    }
    ...
    public void clockTick(ClockTickEvent cte){
        ...
        if(trainDataVolatile.getM_LOC() == ETCSVariables.M_LOC_NOW){
            sendPositionReport();
            this.localBus.post(new TrainDataChangeEvent("tsm", Arrays.asList("td"), "M_LOC", ETCSVariables.M_LOC_NOT_AT_BALISE_GROUP));
        }
    }
    ...
    private void sendPositionReport() {
        ...
        localBus.post(new SendMessageEvent("tsm", Arrays.asList("ms"),message136, this.messageDestination));
    }
