 ...
 */
public abstract class Message<Payload extends ebd.internal.Payload> {
     ...
     * @author Christopher Bernjus
     */
    public static Message<ebd.internal.Payload> generateFrom(String jsonString) throws ClassNotFoundException {
        Gson gson = new Gson();
        ...
        return (Message<ebd.internal.Payload>) gson.fromJson(jsonString, clazz);
    }
