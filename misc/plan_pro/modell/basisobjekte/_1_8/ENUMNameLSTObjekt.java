...
/**
 * <p>Java-Klasse f�r ENUMName_LST_Objekt.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * <p>
 * <pre>
 * &lt;simpleType name="ENUMName_LST_Objekt">
 ...
 * 
 */
@XmlType(name = "ENUMName_LST_Objekt")
@XmlEnum
public enum ENUMNameLSTObjekt {
    ...
    public static ENUMNameLSTObjekt fromValue(String v) {
        for (ENUMNameLSTObjekt c: ENUMNameLSTObjekt.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
