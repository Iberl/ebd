 ...
 *         &lt;element name="Signal_Fstr" type="{http://www.plan-pro.org/modell/Signale/1.8.0}CSignal_Fstr" minOccurs="0"/>
 *         &lt;element name="Signal_Fstr_Aus_Inselgleis" type="{http://www.plan-pro.org/modell/Signale/1.8.0}CSignal_Fstr_Aus_Inselgleis" minOccurs="0"/>
 *         &lt;element name="Signal_Fstr_S" type="{http://www.plan-pro.org/modell/Signale/1.8.0}CSignal_Fstr_S" minOccurs="0"/>
 *         &lt;element name="Signal_PZB" type="{http://www.plan-pro.org/modell/Signale/1.8.0}CSignal_PZB" minOccurs="0"/>
 *         &lt;choice>
 *           &lt;element name="Signal_Fiktiv" type="{http://www.plan-pro.org/modell/Signale/1.8.0}CSignal_Fiktiv"/>
 *           &lt;element name="Signal_Real" type="{http://www.plan-pro.org/modell/Signale/1.8.0}CSignal_Real"/>
 *         &lt;/choice>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
    ...
    extends CPunktObjekt
{
    ...
    @XmlElement(name = "Signal_PZB")
    protected CSignalPZB signalPZB;
    ...
    /**
     * Ruft den Wert der signalPZB-Eigenschaft ab.
     * 
     * @return
     *     possible object is
     *     {@link CSignalPZB }
     *     
     */
    public CSignalPZB getSignalPZB() {
        return signalPZB;
    }

    /**
     * Legt den Wert der signalPZB-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link CSignalPZB }
     *     
     */
    public void setSignalPZB(CSignalPZB value) {
        this.signalPZB = value;
    }
