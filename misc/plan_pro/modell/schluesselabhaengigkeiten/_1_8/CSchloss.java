...
import modell.verweise._1_8.TCIDSchluessel;
 ...
 *       &lt;sequence>
 *         &lt;element name="ID_Schluessel" type="{http://www.plan-pro.org/modell/Verweise/1.8.0}TCID_Schluessel"/>
 *         &lt;element name="Schluessel_In_Grdst_Eingeschl" type="{http://www.plan-pro.org/modell/Schluesselabhaengigkeiten/1.8.0}TCSchluessel_In_Grdst_Eingeschl"/>
 *         &lt;choice>
 *           &lt;element name="Schloss_BUE" type="{http://www.plan-pro.org/modell/Schluesselabhaengigkeiten/1.8.0}CSchloss_BUE"/>
 *           &lt;element name="Schloss_Gsp" type="{http://www.plan-pro.org/modell/Schluesselabhaengigkeiten/1.8.0}CSchloss_Gsp"/>
 *           &lt;element name="Schloss_Sk" type="{http://www.plan-pro.org/modell/Schluesselabhaengigkeiten/1.8.0}CSchloss_Sk"/>
 *           &lt;element name="Schloss_Sonderanlage" type="{http://www.plan-pro.org/modell/Schluesselabhaengigkeiten/1.8.0}CSchloss_Sonderanlage"/>
 *           &lt;element name="Schloss_Ssp" type="{http://www.plan-pro.org/modell/Schluesselabhaengigkeiten/1.8.0}CSchloss_Ssp"/>
 *           &lt;element name="Schloss_W" type="{http://www.plan-pro.org/modell/Schluesselabhaengigkeiten/1.8.0}CSchloss_W"/>
 *         &lt;/choice>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
